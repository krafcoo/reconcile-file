...
class SimpleIdAndReferenceMatchingStrategyTest {
    ...
    void compare_identical() {
        ...
        final MatchingResult matchingResult = matchingStrategy.compare(left, right);
        assertNotNull(matchingResult);
        assertEquals(2, matchingResult.getMatched1().size());
        assertEquals(2, matchingResult.getMatched2().size());
        assertEquals(2, matchingResult.getNotMatched1().size());
        assertEquals(2, matchingResult.getNotMatched2().size());
